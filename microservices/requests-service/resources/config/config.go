...
type AppConfig struct {
	Name string `envconfig:"APP_NAME" default:"requests-service"`
...
type DBConfig struct {
	DSN string `envconfig:"DATABASE_DSN" default:"host=localhost user=postgres password=postgres dbname=ufanet_requests port=5432 sslmode=disable TimeZone=Asia/Yekaterinburg"`
}
